...
export function PaywallScreen({ onClose, onStartTrial }: PaywallScreenProps) {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-[#f2f2f7] to-[#90C7FE] flex flex-col overflow-hidden">
      {/* Fixed Header */}
      ...
      <motion.div
        ...
        className="fixed bottom-0 left-0 right-0 bg-gradient-to-b from-transparent via-[#90C7FE] to-[#90C7FE] px-6 pt-8 pb-8"
      >
        ...
        <p className="text-center text-[32px] font-bold leading-[120%] tracking-[0.4px] text-[rgb(10,132,255)] mb-8">
          Only $0.33 / Day
        </p>
