import svgPaths from "./svg-4jiaeetmq9";
...
function Ill3() {
  return (
    <div className="absolute contents left-[42.5px] top-[64px]" data-name="ill">
      <div className="absolute flex h-[225.337px] items-center justify-center left-[42.5px] top-[70.74px] w-[192.147px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "19" } as React.CSSProperties}>
      ...
      <div className="absolute flex h-[240.964px] items-center justify-center left-[170.83px] top-[64px] w-[188.669px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "76" } as React.CSSProperties}>
...
export default function FirstScreen() {
  return (
    <div className="bg-gradient-to-b from-[#f2f2f7] overflow-clip relative rounded-[48px] size-full to-[#0a84ff]" data-name="First Screen">
      ...
      <Content />
      <Ill3 />
      <div className="absolute flex h-[185.771px] items-center justify-center left-1/2 top-[268px] translate-x-[-50%] w-[335.373px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "40" } as React.CSSProperties}>
